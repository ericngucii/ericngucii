...
| :--- | :--- | :--- |
| **[Argus](https://github.com/lucasngucii/Argus)** <br /><sub>v0.1 · alpha</sub> | ... | `Go` `SQLite` |
| **[nodeterm](https://github.com/eneskirca/nodeterm)** <br /><sub>contributor</sub> | Node-based terminal manager. Every shell is a real PTY node on an infinite pan/zoom canvas, and tmux keeps sessions — including running agents — alive across app restarts and reboots. One core behind a platform seam, so the same renderer ships as a desktop app, a self-hosted browser edition over WebSocket-RPC, and an iOS companion. | `TypeScript` `Electron` `React Flow` `node-pty` |
| **[product-hub](https://github.com/lucasngucii/product-hub)** <br /><sub>contributor</sub> | ... | `NestJS` `MongoDB` `React` `TypeScript` |
| **[face-detection](https://github.com/lucasngucii/face-detection)** | ... | `Python` `scikit-learn` |
| **[clickhouse-owl](https://github.com/diepnghitinh/clickhouse-owl)** <br /><sub>contributor</sub> | ... | `Next.js` `TypeScript` |
---
